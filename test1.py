...
# # Define socket_symbols_map as a global variable
# socket_symbols_map = {}
...
#         symbol_data = message
#         print(symbol_data)
#         messege_send(symbol_data, socket_symbols_map)  # Pass socket_symbols_map to messege_send
...
#     global socket_symbols_map  # Declare socket_symbols_map as global
        ...
        try:
            ...
            if access_token and symbols:
                ...
                for i, socket_id in enumerate(socket_ids):
                    ...
                    socket_symbols_map[socket_id] = symbols_for_socket
